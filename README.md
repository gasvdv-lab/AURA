...
v0.9.0 introduceert een begrensde Attention Kernel. Uit reeds toegestane percepties, herinneringen, beliefs en hypotheses worden deterministisch maximaal vier evidence-items geselecteerd. Alleen die selectie gaat naar de volgende gecontroleerde modelcontext.

Aandacht creëert geen kennis en heeft geen toegang tot `WORLD_STATE`. Er is geen nieuwsgierigheid, engagementscore, beloning, autonoom doel of zelfstandige actie. Selectie, wissen en snapshot/herstel worden causaal vastgelegd.

## Cumulatief behouden uit v0.8.8
